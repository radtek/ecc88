...
public class PagingTool extends Paging 
{
	...
	public String getInfoTags() 
	{
		...
		sb.append("&nbsp;&nbsp;"+Labels.getLabel("EachPage")+"<input onchange='setZKAttr(document.getElementById(\""+this.getUuid()+"\"),\"pgsz\",this.value)' type='text' size='2' value='"+super.getPageSize()+"'>"+Labels.getLabel("Article"));
		sb.append("</div>");

...
//		String maxdate = simpleReport.getPropertyValue("latestCreateTime");
		...
		lbok1.setValue(okcount + Labels.getLabel("Article"));
		lbdanger1.setValue(warningcount + Labels.getLabel("Article"));

		lberror1.setValue(errorcount + Labels.getLabel("Article"));

		lbdisable1.setValue(disablecount + Labels.getLabel("Article"));
